...
class Stage1Activity05Intro extends StatefulWidget {
  final VoidCallback onDone;

  const Stage1Activity05Intro({super.key, required this.onDone});

  @override
  State<Stage1Activity05Intro> createState() => _Stage1Activity05IntroState();
}
...
class _Stage1Activity05IntroState extends State<Stage1Activity05Intro>
  ...
  final _steps = const <_IntroStep>[
    _IntroStep(
      ...
      audio: "audio/stage1/activity05/intro_letter_ra.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "රළ",
      emoji: "🌊",
      audio: "audio/stage1/activity05/intro_waves.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "රස",
      emoji: "😋",
      audio: "audio/stage1/activity05/intro_taste.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "රවුම",
      emoji: "⭕",
      audio: "audio/stage1/activity05/intro_circle.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "රතු",
      emoji: "🔴",
      audio: "audio/stage1/activity05/intro_red.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.allCards,
      audio: "audio/stage1/activity05/intro_all.mp3",
    ),
  ];
