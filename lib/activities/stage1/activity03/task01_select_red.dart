...
class S1A3Task01SelectRed extends StatelessWidget {
  final TaskCallbacks callbacks;
  const S1A3Task01SelectRed({super.key, required this.callbacks});

  @override
  Widget build(BuildContext context) {
    return AkSelectColorCircleTask(
      prompt: "\"රතු\" පාට තෝරන්න.",
      audioAsset: "audio/stage1/activity03/task01_red.mp3",
      callbacks: callbacks,
      options: const [
        AkColorCircleOption(label: "රතු", color: Colors.red, isCorrect: true),
