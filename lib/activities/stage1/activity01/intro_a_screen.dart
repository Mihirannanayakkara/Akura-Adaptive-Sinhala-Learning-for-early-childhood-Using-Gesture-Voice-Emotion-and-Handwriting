...
class Stage1Activity01Intro extends StatefulWidget {
  final VoidCallback onDone;

  const Stage1Activity01Intro({super.key, required this.onDone});

  @override
  State<Stage1Activity01Intro> createState() => _Stage1Activity01IntroState();
}
...
class _Stage1Activity01IntroState extends State<Stage1Activity01Intro>
  ...
  final _steps = const <_IntroStep>[
    ...
    _IntroStep(
      ...
      audio: "audio/stage1/activity01/intro_letter_a.mp3",
    ),
    ...
    _IntroStep(
      ...
      word: "අම්මා",
      emoji: "👩‍🍼",
      audio: "audio/stage1/activity01/intro_amma.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "අලියා",
      emoji: "🐘",
      audio: "audio/stage1/activity01/intro_aliya.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "අල",
      emoji: "🥔",
      audio: "audio/stage1/activity01/intro_ala.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "අත",
      emoji: "✋",
      audio: "audio/stage1/activity01/intro_atha.mp3",
    ),

    // 3) Finally show all 4 cards
    _IntroStep(
      mode: _IntroMode.allCards,
      audio: "audio/stage1/activity01/intro_all.mp3",
    ),
  ];
  ...
  Future<void> _run() async {
    ...
    for (int i = 0; i < _steps.length; i++) {
      ...
      final hold = switch (step.mode) {
        _IntroMode.letter => const Duration(milliseconds: 19500),
        _IntroMode.singleCard => const Duration(milliseconds: 3000),
        _IntroMode.allCards => const Duration(milliseconds: 4500),
      };
  ...
  Widget _buildStep(_IntroStep step) {
    switch (step.mode) {
      ...
      case _IntroMode.allCards:
        return _AllCardsGrid(items: _words, letter: "අ");
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          // ✅ UPDATED: bigger letter, centered in a square area (same as Activity02)
          Container(
            width: 240,
            height: 240,
            decoration: BoxDecoration(
