...
class Stage1Activity06Intro extends StatefulWidget {
  final VoidCallback onDone;

  const Stage1Activity06Intro({super.key, required this.onDone});

  @override
  State<Stage1Activity06Intro> createState() => _Stage1Activity06IntroState();
}
...
class _Stage1Activity06IntroState extends State<Stage1Activity06Intro>
  ...
  final _steps = const <_IntroStep>[
    _IntroStep(
      ...
      audio: "audio/stage1/activity06/intro_letter_u.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "උණගස",
      emoji: "🎋",
      audio: "audio/stage1/activity06/intro_bamboo.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "උදය",
      emoji: "🌅",
      audio: "audio/stage1/activity06/intro_morning.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "උකුස්සා",
      emoji: "🦅",
      audio: "audio/stage1/activity06/intro_eagle.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.singleCard,
      word: "උන",
      emoji: "🤒",
      audio: "audio/stage1/activity06/intro_fever.mp3",
    ),
    _IntroStep(
      mode: _IntroMode.allCards,
      audio: "audio/stage1/activity06/intro_all.mp3",
    ),
  ];
  ...
  Future<void> _run() async {
    ...
    for (int i = 0; i < _steps.length; i++) {
      ...
      final hold = switch (step.mode) {
        _IntroMode.letter => const Duration(milliseconds: 18500),
        _IntroMode.singleCard => const Duration(milliseconds: 3000),
        _IntroMode.allCards => const Duration(milliseconds: 4000),
      };
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                letter,
                style: const TextStyle(fontSize: 170, fontWeight: FontWeight.w900),
              ),
            ),
          ),
